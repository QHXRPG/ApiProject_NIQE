...
def niqe(image: UploadFile = File(...)):
    # 保存上传的图像
    ...
    inputImgData = np.array(img.convert('LA'))[:,:,0]
    patch_size = 96
    ...
    return {"score": niqe_score, "shape": img_shape}

if __name__ == "__main__":
    uvicorn.run("niqe:app", host="127.0.0.1", port=8000)
